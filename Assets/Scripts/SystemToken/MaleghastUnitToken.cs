...
[Serializable]
public class MaleghastUnitToken : SystemToken
{
    #region Registration
    [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.BeforeSceneLoad)]
    private static void Register()
    {
        SystemTokenRegistry.RegisterSystem("Maleghast Unit");
        SystemTokenRegistry.RegisterInterfaceCallback("Maleghast Unit", DeserializeAsInterface);
        SystemTokenRegistry.RegisterSimpleCallback("Maleghast Unit|AddTokenModal", AddTokenModal);
    }
